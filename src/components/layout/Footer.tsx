  ...
  return (
    <footer className="bg-black text-white py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-r from-gray-700/30 to-gray-900/30 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '-2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            {/* Quick Links */}
            <motion.div variants={itemVariants}>
              <h4 className="text-yellow-400 font-semibold mb-4 text-lg">Quick Links</h4>
            ...
            {/* Contact Info */}
            <motion.div variants={itemVariants}>
              <h4 className="text-yellow-400 font-semibold mb-4 text-lg">Contact Info</h4>
              <div className="space-y-3">
                ...
                >
                  <div className="w-5 h-5 bg-yellow-400 rounded-full flex-shrink-0"></div>
                  <p className="text-gray-300">info@projectcatalogueltd.com</p>
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              © 2024 Project Catalogue Limited. All rights reserved. | RC: 1508332
            </motion.p>
