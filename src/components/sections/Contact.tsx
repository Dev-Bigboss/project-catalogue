...
export default function Contact() {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Us",
      details: "info@projectcataloguelimited.com",
  ...
  return (
    <section
      id="contact"
      className="py-24 bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 relative overflow-hidden"
    >
      {/* Background Elements */}
      <div className="absolute inset-0 opacity-20">
        ...
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-white/20 to-gray-100/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse"
        ...
        >
          ...
          <motion.div className="text-center mb-16" variants={itemVariants}>
            ...
            >
              ...
              team today and let&apos;s create something extraordinary together.
            </motion.p>
          </motion.div>
